...
class DayNightApp extends StatelessWidget {
  const DayNightApp({super.key});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Day Night Switch',import 'dart:math';
...
class DayNightApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const DayNightHomePage(),
    );
  }
}

class DayNightHomePage extends StatefulWidget {
  const DayNightHomePage({super.key});

  @override
  DayNightHomePageState createState() => DayNightHomePageState();
}

class DayNightHomePageState extends State<DayNightHomePage>
        ...
        child: Stack(
          children: <Widget>[
            ...
            Positioned(
              ...
              child: Image.asset(
                val
                    ? 'assets/daynight/mountain2_night.png'
                    : 'assets/daynight/mountain2.png',
                fit: BoxFit.cover,
              ),
            ),
            Positioned(
              ...
              child: Image.asset(
                val
                    ? 'assets/daynight/mountain_night.png'
                    : 'assets/daynight/mountain1.png',
                fit: BoxFit.cover,
              ),
            ),
            AnimatedBuilder(
            ...
            Center(
              child: DayNightSwitch(
                value: val,
                moonImage: const AssetImage('assets/daynight/moon.png'),
                onChanged: (value) {
                  setState(() {
                    val = value;
                  });
          ...
          return Stack(
            ...
            children: <Widget>[
              ...
              SizedBox(
                ...
                height: 256,
                child: val
                    ? Image.asset('assets/daynight/moon.png')
                    : const CircleAvatar(
