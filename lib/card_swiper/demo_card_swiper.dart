...
import 'config.dart';
import 'example_custom.dart';
import 'example_swiper_in_scrollview.dart';
import 'page_indicator.dart';
import 'swiper.dart';
import 'swiper_control.dart';
import 'wiper_pagination.dart';
      ...
      body: Stack(
        children: <Widget>[
          ...
          Swiper.children(
            ...
            children: <Widget>[
              Image.asset(
                'assets/card_swiper/1.png',
                fit: BoxFit.contain,
              ),
              Image.asset(
                'assets/card_swiper/2.png',
                fit: BoxFit.contain,
              ),
              Image.asset('assets/card_swiper/3.png', fit: BoxFit.contain)
            ],
          )
        ],
      ),
